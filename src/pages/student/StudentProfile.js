...
import DownloadIcon from '@mui/icons-material/Download';
import { Avatar, Box, Container, Fade, Grid, Paper, Slide, Typography, Button } from '@mui/material';
import { styled } from '@mui/material/styles';
import { QRCodeCanvas } from 'qrcode.react';
...
const StudentProfile = () => {
  ...
  const downloadQRCode = () => {
    ...
    downloadLink.href = pngUrl;
    downloadLink.download = `${currentUser.name}_QRCode.png`;
    document.body.appendChild(downloadLink);
    downloadLink.click();
        ...
        <ProfilePaper elevation={3}>
          <Grid container spacing={2}>
            <Grid item xs={12} textAlign="center">
              <Box display="flex" flexDirection="column" alignItems="center">
                <Fade in={true} timeout={800}>
                  <ProfileAvatar alt="Student Avatar" src={currentUser.profilePicture || ''}>
                    {String(currentUser.name).charAt(0)}
                  </ProfileAvatar>
                </Fade>
              </Box>
            ...
            <Grid item xs={12}>
              <Box display="flex" flexDirection="column" gap={2}>
                ...
                <Typography variant="body1">
                  <strong>School:</strong> {currentUser.school.schoolName}
                </Typography>
                <Typography variant="body1">
                ...
                <Typography variant="body1">
                  <strong>Emergency Contact:</strong> {currentUser.guardianPhone}
                </Typography>
              </Box>
            </Grid>
          </Grid>
